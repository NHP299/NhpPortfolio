...
const skills = [
  ...
  { name: "Axios", level: 75, category: "frontend" },
  ...
  { name: "Docker Compose", level: 70, category: "tools" },
  ...
  // Testing
  { name: "JUnit", level: 70, category: "testing" },
  { name: "API testing (Postman)", level: 75, category: "testing" },
];


const categories = ["all", "frontend", "backend", "tools", "database", "language", "testing"];
